...
public class GameScene: SKScene, SKPhysicsContactDelegate
{
    ...
    public func didBegin(_ contact: SKPhysicsContact) -> Void
    {
        ...
        if ((firstBody.categoryBitMask & CollisionCategories.Player != 0) && (secondBody.categoryBitMask & CollisionCategories.Player != 0))
        {
